...
const char* BACKEND_HOST = "10.42.103.254";
...
void setup() {
  ...
  // CÁMARA PRIMERO: reserva su canal LEDC (0) antes que los motores. Si los
  // motores se inicializan primero, la cinta agarra el canal 0 y la cámara se
  // lo "roba" -> ledcWrite(ENA_CINTA,0) ya no apaga la cinta y gira indefinida.
  iniciarCamara();
...
void rodillosParaBotarPalta(int v1, int v2) {
  // Expulsión: ambos rodillos en el MISMO sentido entre sí, pero CONTRARIO al
  // giro de evaluación -> empuja la palta hacia afuera en vez de girarla en su sitio.
  digitalWrite(IN1_RODILLO1, HIGH); digitalWrite(IN2_RODILLO1, LOW); ledcWrite(ENA_RODILLO1, v1);
